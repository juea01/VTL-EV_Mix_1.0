...
def generate_routefile(numCarsToGenerate,numberOfTimeSteps):
    ...
    with open("../maps/NormalIntersection_no_TLS/randomSpec1_600.rou.xml", "w") as routes:
        print("""<routes>
...
generate_routefile(600,numberOfTimeSteps)
# if you change scale factor here please also chage to scale factor value down there
simlib.setUpSimulation("../maps/NormalIntersection_no_TLS/crossSpec1_600.sumocfg",1) 
step = 0
