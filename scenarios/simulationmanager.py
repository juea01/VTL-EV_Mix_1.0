...
class SimulationManager():
    ...
    def createPlatoon(self, vehicles):
        ...
        platoonl = platoon.Platoon(vehicles)
        self.platoons.append(platoonl)
    ...
    def getAllVehiclesInPlatoons(self):
        ...
        return simlib.flatten(p.getAllVehiclesByName() for p in self.getActivePlatoons())
    ...
    def handleSimulationStep(self):
        ...
        if self.platoonCreation:
            ...
            for vehicleID in vehiclesNotInPlatoons:
                vehiclel = vehicle.Vehicle(vehicleID)
                self.vehicles.append(vehiclel)
                vehicleLane = vehiclel.getLane()
