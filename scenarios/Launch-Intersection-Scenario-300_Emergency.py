...
def generate_routefile(percentageEmergencyVehicle,numCarsToGenerate,numberOfTimeSteps):
    ...
    with open("../maps/NormalIntersection_no_TLS/randomSpec1_300_Emergency.rou.xml", "w") as routes:
        print("""<routes>
...
#generate_routefile(0.01,300,numberOfTimeSteps) #include 1 % of EV
generate_routefile(0.02,300,numberOfTimeSteps) #include 2 % of EV
# if you change scale factor here please also chage to scale factor value down there
simlib.setUpSimulation("../maps/NormalIntersection_no_TLS/crossSpec1_300_Emergency.sumocfg",1) 
step = 0
